...
print(m.log(numero)) #logaritmo naturale, con libreria math
print(m.log10(numero)) #logaritmo in base 10, con libreria math
print(m.exp(numero)) #esponenziale, con libreria math
print(m.factorial(numero)) #fattoriale, con libreria math
print(m.gcd(numero,numero2)) #massimo comune divisore, con libreria math
print(m.lcm(numero,numero2)) #minimo comune multiplo, con libreria math
...
print(numero*numero2) #moltiplicazione
